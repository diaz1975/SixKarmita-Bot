...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '🥷 Six Karmita Bot - WhatsApp ', thumbnailUrl: await(await fetch(global.img)).buffer(), sourceUrl: yt }}}
